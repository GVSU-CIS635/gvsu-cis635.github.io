...
| 4 (09/16) | Object Analysis: Similarity and distance measures: [slides](assets/pdf/similarity-distance.pdf) <br> Feature Analysis: Relationships: [slides](assets/pdf/feature-relationships.pdf) | {ref}`resources <content:references:w4>` |
| 5 (09/23) | Feature Extraction: [slides] <br> Feature Selection: [slides] |  |
| 6 (09/30) |  |  |
