...
| 10. 10/27 | [Supervised/Unsupervised Learning](assets/pdf/supervised-unsupervised-learning.pdf) \| [Decision Tree](assets/pdf/decision-tree.pdf) | {ref}`resources <content:references:w10>` |
| 11. 11/03 | [Bayesian Classification](assets/pdf/bayesian-classification.pdf), [Ensemble Methods](assets/pdf/ensemble-methods.pdf), Classifier Evaluation, Model Selection <br> Quiz 5 | {ref}`resources <content:references:w11>` |
